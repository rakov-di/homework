...
> Тесты готовы (см. [Описание](#about)) но хотелось бы еще кое что сделать (см. [TODO](#todo)). Продолжаю работу. Уделю еще как минимум среду. Если вдруг если возможность проверить работу чуть позже - в ней будет сделано чуть больше и лучше. 
